class Company < ActiveRecord::Base
  ...
  INDUSTRY = ['Accounting', 'Airlines/Aviation', 'Alcoholic beverage', "Alternative Disputs Resolution", "Alternative Medicine", "Animation", "Apparel & Fashion", 
   ...
   "Oil & Energy","Professional Training & Coaching", "Restaurants", "Research", "Security and Investigations", "Sports", "Staffing and Recruiting", "Transportation", "Venture Capital & Private Equity", 'Wine and Spirits', "Other"]
  ...
  def company_jobs
    jobs.select { |job| job.company_name == company.name }
  end
end
